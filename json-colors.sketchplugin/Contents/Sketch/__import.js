...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var importJson = function importJson(jsonFile) {
    Object.keys(jsonFile).forEach(function (color) {
      Object.keys(jsonFile[color]).forEach(function (density) {
        var swatch = Swatch.from({
          name: "".concat(color, " /  ").concat(density),
          color: jsonFile[color][density]
        });
        doc.swatches.push(swatch);
      });
    });
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Import completed ✅");
  };
